...
const pathUpgradeParameters = path.join(__dirname, "./upgrade_parameters.json");
...
const upgradeParameters = require(pathUpgradeParameters);
...
async function main() {
    ...
    try {
        console.log("Verify polygonDataCommittee");
        await hre.run("verify:verify", {
