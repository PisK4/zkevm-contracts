    ...
    ICDKValidiumErrors
{
    ...
    IVerifierRollup public immutable rollupVerifier =
        IVerifierRollup(0x0000000000000000000000000000000000000000);

    // Global Exit Root interface
    IPolygonZkEVMGlobalExitRoot public immutable globalExitRootManager =
        IPolygonZkEVMGlobalExitRoot(0x0000000000000000000000000000000000000000);

    // PolygonZkEVM Bridge Address
    IPolygonZkEVMBridge public immutable bridgeAddress =
        IPolygonZkEVMBridge(0x0000000000000000000000000000000000000000);

    // CDK Data Committee Address
    ICDKDataCommittee public immutable dataCommitteeAddress =
        ICDKDataCommittee(0x0000000000000000000000000000000000000000);

    // L2 chain identifier
    uint64 public immutable chainID = 1;

    // L2 chain identifier
    uint64 public immutable forkID = 7;
